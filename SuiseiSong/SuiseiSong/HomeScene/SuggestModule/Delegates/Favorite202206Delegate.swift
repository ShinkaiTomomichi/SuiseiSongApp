...
//  SuiseiSong
//
//  Created by shinkaitomomichi on 2022/08/04.
//

import UIKit

class Favorite202206Delegate: NSObject, SuggestModuleViewDelegateProtocol {
    var navigationController: UINavigationController?
    var filterCompletion: (() -> Void)?
    
    // セルの数
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return Songs.shared.favorite202206Songs.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.song = Songs.shared.favorite202206Songs[index]
